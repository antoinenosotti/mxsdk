interface IEntities {
    entities: (
        {
            fullPath: string; validationRules: any[]; dataStorageGuid: string; documentation: string; isRemote: boolean; moduleName: string; accessRules: any[]; indexes: any[]; generalization: { generalization: string; $Type: string; $ID: string } | { hasChangedDate: boolean; hasChangedBy: boolean; hasCreatedDate: boolean; persistable: boolean; hasOwner: boolean; $Type: string; $ID: string }; name: string; location: { x: number; y: number }; attributes: ({ dataStorageGuid: string; documentation: string; name: string; type: { length: number; $Type: string; $ID: string }; $Type: string; value: { defaultValue: string; $Type: string; $ID: string }; $ID: string } | { dataStorageGuid: string; documentation: string; name: string; type: { $Type: string; $ID: string }; $Type: string; value: { defaultValue: string; $Type: string; $ID: string }; $ID: string } | { dataStorageGuid: string; documentation: string; name: string; type: { localizeDate: boolean; $Type: string; $ID: string }; $Type: string; value: { defaultValue: string; $Type: string; $ID: string }; $ID: string } | { dataStorageGuid: string; documentation: string; name: string; type: { enumeration: string; $Type: string; $ID: string }; $Type: string; value: { defaultValue: string; $Type: string; $ID: string }; $ID: string })[]; eventHandlers: any[]; remoteSource: string; id: string; structureTypeName: string
        })[];
    number: number;
    moduleName: string;
}
...
function main() {
    ...
    enum DataTypeMapping {
        ...
        DomainModels$EnumerationAttributeType = "string",
        ...
        const fields = entity.attributes.map((attribute) => {
            ...
            if (logicalTypes.hasType(attribute.type)) {
                ...
                for (const propName in logicalType) {
                    (field as any)[propName] = logicalType[propName];
                }
            }
            return field;
        });
