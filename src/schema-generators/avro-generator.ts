...
function main() {
    ...
    sampleDomain.revision.entities.filter(entity => !entity.persisted).forEach((entity: any) => {
        let fields = entity.attributes.map((attribute: any) => {
            const
        ...
        fields = fields.concat(entity.associations.filter((association: any) => association.parent).map((association: any) => {
            return {
